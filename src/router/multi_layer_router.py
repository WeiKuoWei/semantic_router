...
class MultiLayerRouter:
    ...
    def __init__(self, use_openai: bool = False):
        ...
        if use_openai:
            try:
                ...
                logging.warning("OpenAI encoder not available. Using SentenceTransformer instead.")
    ...
    async def route_query(self, query: str) -> Dict[str, Any]:
        """
        Route a query through the two-layer system to find the best expert.
        ...
        # Get the response function for this expert
        response_func = self.expert_responses.get(best_expert, self.fallback_response)
        
        # Return the expert's response
        return await response_func(query)